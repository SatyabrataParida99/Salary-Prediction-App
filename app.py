...
model = pickle.load(open(r'D:\VS Code Project\linear_regression_model.pkl', 'rb'))
...
st.write("The model was trained using a dataset of salaries and years of experience.built by Satyabrata Parida")
